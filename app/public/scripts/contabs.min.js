$(function () {
  function t (t) {
    var e = 0
    return $(t).each(function () {e += $(this).outerWidth(!0)}), e
  }
  ...
  function r () {$('.page-tabs-content').children('[data-id]').not(':first').not('.active').each(function () {$('.J_iframe[data-id="' + $(this).data('id') + '"]').remove(), $(this).remove()}), $('.page-tabs-content').css('margin-left', '0')}
